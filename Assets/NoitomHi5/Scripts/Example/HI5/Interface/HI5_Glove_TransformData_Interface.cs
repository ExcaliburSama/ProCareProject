...
namespace HI5
{
    public class HI5_Glove_TransformData_Interface : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            //{
            //    foreach (KeyValuePair<EHi5_Glove_TransformData_Bones, Transform> item in LeftHandBones)
            //    {
            //        Debug.Log("LeftHandBones" + item.Key + "postion = " + item.Value.position + "   rotation =" + item.Value.rotation);
            //    }
            //}
            //if (RightHandBones != null)
            //{
            //    foreach (KeyValuePair<EHi5_Glove_TransformData_Bones, Transform> item in RightHandBones)
            //    {
            //        Debug.Log("RightHandBones" + item.Key + "postion = " + item.Value.position + "   rotation =" + item.Value.rotation);
            //    }
            //}
            //if (mLeftHand != null)
            //{
